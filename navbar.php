...
<nav class="navbar navbar-expand-lg" style="background-color: #841617;">
    <div class="container">
        <a class="navbar-brand text-white" href="index.php">OU Football Hub</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo $current_page == 'index.php' ? 'active text-warning' : 'text-white'; ?>" href="index.php">Home</a>
                </li>
                <li class="nav-item">
